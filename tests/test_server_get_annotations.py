...
@pytest.mark.asyncio
async def test_get_annotations_descends_through_attachment(monkeypatch):
    ...
    result = await server.get_annotations(item_key="PAPER001", ctx=DummyContext())
...
@pytest.mark.asyncio
async def test_get_annotations_accepts_attachment_key(monkeypatch):
    ...
    result = await server.get_annotations(item_key="ATTACH01", ctx=DummyContext())
...
@pytest.mark.asyncio
async def test_get_annotations_dedupes_across_paths(monkeypatch):
...
@pytest.mark.asyncio
async def test_get_annotations_handles_multiple_attachments(monkeypatch):
...
@pytest.mark.asyncio
async def test_get_annotations_reports_none_when_empty(monkeypatch):
...
@pytest.mark.asyncio
async def test_get_annotations_paginates_through_many_annotations(monkeypatch):
